          ...
          <div className="glass-card p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="text-lg font-black text-white">{formatTokenAmount(bounty.appealBond, 6)} USDC</div>
              ...
              <div>
                ...
                <div className="text-lg font-black text-white">{Math.floor((dispute.revealDeadline - dispute.commitDeadline) / 3600)} Hours</div>
